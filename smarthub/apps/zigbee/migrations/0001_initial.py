    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ieee_address', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zigbee_device', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='zigbee.zigbeedevice')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('broker_message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='zigbee.zigbeemessage')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
