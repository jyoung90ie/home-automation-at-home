    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger_type', models.CharField(choices=[('Less than', 'Less than'), ('Less than or equal to', 'Less than or equal to'), ('Equal to', 'Equal to'), ('Greater than or equal to', 'Greater than or equal to'), ('Greater than', 'Greater than'), ('Not equal to', 'Not equal to')], default='Equal to', max_length=100)),
                ('is_enabled', models.BooleanField(default=True)),
